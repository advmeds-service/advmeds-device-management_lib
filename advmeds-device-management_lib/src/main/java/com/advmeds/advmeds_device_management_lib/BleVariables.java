...
//   _CONNECT 藍牙連線後，傳輸邏輯名字
    ...
    static final String BLE_D40B_TD3261B_UPLOAD = "FORA D40B";
    ...
    static final String BLE_P30B_TD3129B_UPLOAD = "FORA P30B";
    ...
    static final String BLE_P80_TD3140_UPLOAD = "FORA P80";
    ...
    static final String BLE_TD3128_UPLOAD = "TaiDoc TD-3128";
    ...
    static final String BLE_TD2555_UPLOAD = "TaiDoc TD-2555";
    ...
    public static final String BLE_W600_TD2560_UPLOAD = "FORA W600";
    ...
    static final String BLE_BF4030_UPLOAD = "BF4030";
    ...
    static final String BLE_IR40_TD1241_UPLOAD = "FORA IR40";
    ...
    static final String BLE_TD1261_UPLOAD = "TaiDoc TD-1261";
    ...
    static final String BLE_TD1035_UPLOAD = "TaiDoc TD-1035";
    ...
    static final String BLE_IR42B_TD1242_UPLOAD = "FORA IR42B";
    ...
    static final String BLE_O2_TD8255_UPLOAD = "FORA O2";
    ...
    static final String BLE_TD8201_UPLOAD = "TaiDoc TD-8201";
    ...
    static final String BLE_TD4257_UPLOAD = "TaiDoc TD-4257";
    ...
    static final String BLE_GD40B_TD4272B_UPLOAD = "FORA GD40B";
    ...
    static final String BLE_TD4216_UPLOAD = "TaiDoc TD-4216";
    ...
    static final String BLE_DSP_COMBO_SENSOR_UPLOAD = "DSP Combo Sensor";
    ...
    static final String BLE_TD4141_UPLOAD = "TaiDoc TD-4141";
    ...
    static final String BLE_TD4206_UPLOAD = "TaiDoc TD-4206";
    ...
    static final String BLE_FORA_MD6_UPLOAD = "FORA MD6";
    ...
    static final String BLE_IMEDI_PLUS_DS101_UPLOAD = "Imedi Plus DS101";
    ...
    static final String BLE_ACR3901U_S1_UPLOAD = "ACR3901U-S1";
